...
# Load main ship data
shipData = pd.read_csv("Filtered_New_England_Processed.csv")[["Ship_Name", "Origin", "DestinationDecl", "Year", "Captain", "Cargo"]].rename(
    columns={
        "Ship_Name": "Ship Name",
...
app.layout = html.Div([
    html.H1("Ship Route Visualizer", style={'textAlign': 'center', 'marginBottom': 5}),
    ...
    dcc.Graph(
        id='route-map',
        style={'backgroundColor': '#B0E0E6', 'marginTop': 5, 'marginBottom': 5},
        config={
            'scrollZoom': False,
            'staticPlot': True,
        }
